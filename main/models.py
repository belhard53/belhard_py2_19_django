...
class Student(models.Model):
    ...
    #  что бы фото раздавались джанго - добавить в главный urls 
    # if settings.DEBUG:
    ...
    #         # сделать проверку на уникальность - если не ok добавить 1,2,...
...
# отменить миграции
# python manage.py migrate main zero - все
# python manage.py migrate main 0001_initial.py - до конкретной
...
CREATE        
s1 = Student(name="Николай", surname="Николаев", active=True)         
s1.save()

Student.objects.create(name="Николай2", surname="Николаев2", active=True) 
или 
s2 = Student.objects.create(name="Николай3", surname="Николаев3", active=True) 
...
male_students = Student.objects.filter(sex='m')
